...
# from google.ai.generativelanguage_v1.types import Part
# from google.ai.generativelanguage_v1.types.content import Content, Part
# from google.ai.generativelanguage_v1.types.content import Content as ContentListUnion 

# # from google.generativeai.types.content_types import Content, Part
# # from google.generativeai.types import ContentListUnion

# # from google.genai.types import Content, ContentListUnion, Part
# # from google.generativeai.types import Content, ContentListUnion, Part
...
# # Example to construct input
# parts = [
#     genai.content.Part.from_text("Tell me a joke"),
#     # genai.content.Part.from_image(image_bytes_or_PIL)
# ]
